...
Usage:
    from ultralytics.xml_utils.py.benchmarks import ProfileModels, benchmark
...
def benchmark(
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.benchmarks import benchmark
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.benchmarks import ProfileModels
