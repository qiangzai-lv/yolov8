...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from ultralytics.xml_utils.py.downloads import safe_download
